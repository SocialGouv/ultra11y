...
export const ACT_RULES: Record<string, ActMapping> = {
  ...
  "24afc2": { engineRules: [], scope: "static", gap: true, note: "letter-spacing:!important in a style attribute" },
  "78fd32": { engineRules: [], scope: "static", gap: true, note: "line-height:!important in a style attribute" },
  "9e45ec": { engineRules: [], scope: "static", gap: true, note: "word-spacing:!important in a style attribute" },
  "46ca7f": { engineRules: [], scope: "static", gap: true, note: "an element marked decorative that is still exposed (focusable, or with a name)" },
